...
<div id="signin-page">
    ...
    <div class="input input-1">
        ...
        <p class="signin-p signin-p-2" style="position: relative;">
            {{ session('config.texts')->pt->recover->input_username }}
            ...
            @endif
            <br />
            <input type="submit" value="{{ session('config.texts')->pt->recover->button_recover }}" class="submit">
        </form>
    </div>
</div>

<div id="footer" class="footer forgot-footer" style="margin-top: 165px;">
    <hr>
    <ul class="footer-ul">
        @if(@session('apikey'))
